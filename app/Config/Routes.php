...
$routes->post('daireler/toplu_ekle', 'DairelerController::topluEkle');
...
$routes->get('personel', 'PersonelController::index',  ['filter' =>['auth','role']]);
$routes->post('personel/store', 'PersonelController::store');
$routes->get('personel/edit/(:num)', 'PersonelController::edit/$1');
$routes->get('personel/delete/(:num)', 'PersonelController::delete/$1');
$routes->post('personel/update', 'PersonelController::update');
